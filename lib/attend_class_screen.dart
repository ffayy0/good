...
import 'attend_select_class.dart'; // استيراد صفحة اختيار الكلاس
            ...
            CustomButton(
              ...
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) => SelectClassScreen(stage: "أولى ابتدائي"),
                  ),
                );
              },
            ),
            ...
            CustomButton(
              ...
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) => SelectClassScreen(stage: "ثاني ابتدائي"),
                  ),
                );
              },
            ),
            ...
            CustomButton(
              ...
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) => SelectClassScreen(stage: "ثالث ابتدائي"),
                  ),
                );
              },
            ),
